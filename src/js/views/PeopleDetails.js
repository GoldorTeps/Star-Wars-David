					...
					<div className="card-body" style={{ height: "13rem", overflowx: "hidden", overflow: "auto" }}>
						...
						<div className="row">
							<div className="col-12 mx-auto">
								...
								<p className="col "><i color="orange" className='bx-pull-left bx bx-tada-hover bxs-quote-alt-left bx-lg' />Un repaso a los distintos seres –vivos, metálicos y de los otros- que habitan en la Galaxia Muy, Muy Lejana.</p>
								<div className="row">
